...
public PanelComboBoxSeleccionPieza() {
     ...
     private void initComponent(){
        ...
        this.Pieza.addItem(" ");this.Pieza.addItem("Placa Madre");this.Pieza.addItem("Procesador");
        this.Pieza.addItem("Tarjeta De Video");this.Pieza.addItem("Ram");this.Pieza.addItem("SSD");
